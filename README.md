...
For example because software such as Unity has autogenerated files after a commit.

Attention! This command will delete all files that have not been commited yet.
